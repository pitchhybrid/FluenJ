# FluenJ — a IDE Java (seção)

Esta seção do vault documenta a transformação do `FluenJ` em uma **IDE para Java** (estilo Eclipse, inicialmente básica), **desktop-only** (Windows/Linux/macOS).
